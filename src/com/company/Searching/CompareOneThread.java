...
public class CompareOneThread implements Runnable{
    ...
    public CompareOneThread(int size, int totalThread, int threadNumber, int whichRow, ArrayList<Record> dizi, double treshold, String girilen) {
    ...
    public void compareIssue(){
        ...
        for (int i = startIndex; i <= endIndex; i++) {
            ...
            if (dizi.get(i).getComplaint_id().equals(girilen)){
                System.out.println(girilen + " | " + dizi.get(i).getComplaint_id());
                String[] words = dizi.get(i).getIssue().split("\\s+");
